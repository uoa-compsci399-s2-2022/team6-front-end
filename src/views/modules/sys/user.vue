...
<!--        </el-form-item>-->
      ...
      <el-table
        ...
        <el-table-column prop="username" label='upi' sortable="custom" header-align="center" align="center"></el-table-column>
		<el-table-column prop="realName" label='username' sortable="custom" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('sys:user:update')" 

type="primary" circle  icon="el-icon-edit"  size="small" @click="addOrUpdateHandle(scope.row.id)"></el-button>
            <el-button v-if="$hasPermission('sys:user:delete')" type="danger" icon="el-icon-delete" circle size="small" @click="deleteHandle(scope.row.id)"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- <el-pagination
