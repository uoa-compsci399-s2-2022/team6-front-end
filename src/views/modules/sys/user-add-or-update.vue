<template>
  <el-dialog :visible.sync="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmitHandle()" label-width="120px">
      <el-form-item prop="username" label="upi">
        <el-input v-model="dataForm.username" placeholder="upi"></el-input>
      </el-form-item>
	  <el-form-item prop="realName" label="username">
	    <el-input v-model="dataForm.realName" placeholder="username"></el-input>
	  </el-form-item>
  ...
  methods: {
    ...
    getInfo () {
      this.$http.get(`/sys/user/${this.dataForm.id}`).then(({ data: res }) => {
        ...
        // Role configuration: Determine whether the role is the default role
